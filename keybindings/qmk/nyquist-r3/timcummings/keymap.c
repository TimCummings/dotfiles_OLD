...
[_QWERTY] = LAYOUT( \
  ...
  KS_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
...
[_LOWER] = LAYOUT( \
  ...
  KC_GRV,  KC_PSLS, KC_7,    KC_8,    KC_9,    KC_PAST, _______, KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, _______, \
  _______, KC_PMNS, KC_4,    KC_5,    KC_6,    KC_PPLS, _______, _______, KC_LPRN, KC_RPRN, KC_UNDS, _______, \
  _______, KC_PDOT, KC_1,    KC_2,    KC_3,    KC_PEQL, _______, _______, KC_LABK, KC_RABK, _______, _______, \
