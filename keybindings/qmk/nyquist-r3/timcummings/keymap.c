...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  // Tap once for Left Control, twice for Escape
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |Hyper | Alt  |GUIEnt|Lower |Space | Bksp |Raise |Alt - | Meh  |  F3  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_LCTL, KC_HYPR, KC_LALT, GUI_ENT, LOWER,   KC_SPC,  KC_BSPC, RAISE,   ALT_MIN, KC_MEH,  KC_F3,   KC_RSFT  \
),
...
[_LOWER] = LAYOUT( \
  ...
  KC_GRV,  KC_PSLS, KC_7,    KC_8,    KC_9,    KC_PAST, _______, KC_LBRC, KC_RBRC, _______, _______, _______, \
  _______, KC_PMNS, KC_4,    KC_5,    KC_6,    KC_PPLS, _______, KC_LPRN, KC_RPRN, _______, _______, _______, \
  _______, KC_PDOT, KC_1,    KC_2,    KC_3,    KC_PEQL, _______, KC_LABK, KC_RABK, _______, _______, _______, \
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |CtlEsc|   A  |GUI Rt|   D  |GUI Lt|   G  | Left | Down |  Up  |Right |   ;  |  "   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
