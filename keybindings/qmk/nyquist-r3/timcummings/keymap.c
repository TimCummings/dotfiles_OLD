...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_PMNS, KC_4,    KC_5,    KC_6,    KC_PPLS, KC_PPLS, KC_LPRN, KC_RPRN, _______, KC_PMNS, _______, \
  _______, KC_PDOT, KC_1,    KC_2,    KC_3,    KC_PEQL, KC_PEQL, KC_LABK, KC_RABK, _______, KC_PDOT, _______, \
  _______, KC_COMM, KC_0,    _______, _______, _______, _______, _______, _______, _______, KC_COMM, _______ \
),
